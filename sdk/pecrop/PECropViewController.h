...
@property (nonatomic) IBOutlet UIScrollView* ratioControlScrollView;
@property (nonatomic) IBOutlet UIView* ratioControlView;
@property (nonatomic) IBOutlet UIView* topBannerView;
@property (nonatomic) IBOutlet UIView* bottomBannerView;
